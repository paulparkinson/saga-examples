...
create pluggable database cdb1_pdb1 admin user admin identified by test file_name_convert=('/opt/oracle/oradata/FREE/pdbseed', 'pdb1');
drop pluggable database cdb1_pdb2 including datafiles;
create pluggable database cdb1_pdb2 admin user admin identified by test file_name_convert=('/opt/oracle/oradata/FREE/pdbseed', 'pdb2');
drop pluggable database cdb1_pdb3 including datafiles;
create pluggable database cdb1_pdb3 admin user admin identified by test file_name_convert=('/opt/oracle/oradata/FREE/pdbseed', 'pdb3');
drop pluggable database cdb1_pdb4 including datafiles;
create pluggable database cdb1_pdb4 admin user admin identified by test file_name_convert=('/opt/oracle/oradata/FREE/pdbseed', 'pdb4');
